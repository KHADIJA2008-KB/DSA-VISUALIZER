...
const categories = [
  ...
  { id: 'stack', label: 'Stack', description: 'Last in, first out. Explore push and pop.', color: 'bg-violet-500', href: '#stack' },
  { id: 'queue', label: 'Queue', description: 'First in, first out. Follow the line.', color: 'bg-amber-500', href: '#queue' },
